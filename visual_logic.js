 ...
 * Wed Apr 17 2024 16:46:49 GMT+0530 (India Standard Time)
...
var piece_dict, x, space, j, k, newpiece, i, save, n, xx;
...
eventHTMLElem('click', 'save', true, function(event) {
  downloadFile(piece_dict, 'save_data.json');
});
eventHTMLElem('click', 'load', true, function(event) {
  openFile(function() {
    ...
    for (var n_index in n_list) {
      n = n_list[n_index];
      if (textCount(n, 'Cube') == 1) {
        xx = 'Cube';
      } else if (textCount(n, 'Rectangle') == 1) {
        xx = 'Rectangle';
      } else {
        xx = 'Halfcube';
      }
